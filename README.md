...
- 파이썬 자료구조/알고리즘
    ...
    - 정렬
        ...
        - 버블정렬 Bubble Sort - 기준값 기준으로 제일 큰 값을 뒤로 정렬
        - 퀵정렬   Quick Sort - 기준값 기준으로 작은값그룹/큰값그룹을 분리한뒤 다시 정렬 재귀호출

    ![정렬](https://raw.githubusercontent.com/been2525/ds-and-algorithm-2024/main/images/sorting.jpg)
